...
const CardSection = () => (
    ...
    <div className="container ">
      ...
      <div className="row">
        <div className="col-4">
          <Card image_url="https://images.pexels.com/photos/3532557/pexels-photo-3532557.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                title="Card title"
                card_text="Some quick example text to build on the card title and make up
